                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-xs text-brand-muted mt-1 flex items-center">
                                                        ...
                                                        {{ $upload->event->name ?? 'Acara Tidak Diketahui' }}
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    @foreach($recentSales as $sale)
                                        <div class="flex items-center gap-3 border-b border-brand-border pb-3 last:border-0 last:pb-0">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-xs text-brand-muted truncate">{{ $sale->photo->event->name ?? 'Acara Tidak Diketahui' }} • {{ $sale->created_at->diffForHumans() }}</p>
                                            </div>
