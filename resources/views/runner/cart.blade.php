        ...
        <main class="flex-1 flex flex-col overflow-y-auto relative bg-brand-light">
            ...
            <header class="h-20 shrink-0 bg-white/70 backdrop-blur-md border-b border-brand-border flex items-center justify-between px-6 sticky top-0 z-40 w-full">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-black text-brand-navy hidden sm:block">Keranjang </h2>
                </div>
                ...
                <div class="flex flex-col lg:flex-row gap-8">
                        ...
                        <div class="bg-white border border-brand-border rounded-2xl shadow-sm p-4 flex flex-col sm:flex-row gap-5 items-center sm:items-start group transition-all hover:border-brand-teal">
                            ...
                            <div class="flex-1 w-full">
                                <div class="flex justify-between items-start">
                                    ...
                                    <form action="{{ route('runner.cart.remove', $photo->id) }}" method="POST">
                                        @csrf
                                        <button type="submit" class="text-brand-muted hover:text-red-500 transition-colors p-1" title="Hapus foto">
                    ...
                    <div class="lg:w-96 flex-shrink-0">
                        <div class="bg-white border border-brand-border rounded-2xl shadow-sm p-6 sticky top-24">
                            ...
                            @if($photos->count() > 0)
                                <form action="{{ route('runner.cart.checkout') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="w-full bg-brand-teal text-white font-black py-4 rounded-xl hover:bg-brand-tealHover transition-colors shadow-lg shadow-brand-teal/20 flex justify-center items-center gap-2 group">
                            ...
                            @else
                                <button disabled class="w-full bg-gray-300 text-gray-500 font-black py-4 rounded-xl shadow-sm flex justify-center items-center gap-2 cursor-not-allowed">
                                    Keranjang Kosong
                                </button>
                            @endif
