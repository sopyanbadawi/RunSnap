        ...
        <main class="flex-1 flex flex-col overflow-y-auto relative bg-brand-light">
            ...
            <div class="p-4 sm:p-6 lg:p-10 w-full max-w-7xl mx-auto flex-1 relative z-10">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    ...
                    <a href="{{ route('runner.events.show', $event->id) }}" class="group bg-white border border-brand-border rounded-2xl overflow-hidden shadow-sm hover:border-brand-teal hover:shadow-xl transition-all duration-300 flex flex-col h-full">
                        <div class="h-40 bg-gray-200 relative overflow-hidden">
                            ...
                            <div class="absolute bottom-4 left-4 text-white">
                                <h4 class="font-black text-base mb-0.5 leading-tight group-hover:text-brand-teal transition-colors">{{ $event->name }}</h4>
                        ...
                        <div class="p-4 bg-white flex justify-between items-center mt-auto border-t border-brand-border/50">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-sm font-black text-brand-teal">{{ $event->photos->count() ?? 0 }}</p>
                            </div>
                        </div>
                    </a>
                    @empty
