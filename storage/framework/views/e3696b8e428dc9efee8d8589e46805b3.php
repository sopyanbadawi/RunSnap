            ...
            <div class="p-4 sm:p-6 lg:p-10 w-full max-w-7xl mx-auto flex-1 relative z-10">
                ...
                <nav class="flex mb-6 text-sm font-bold text-brand-muted" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="<?php echo e(route('runner.dashboard')); ?>" class="hover:text-brand-teal transition-colors flex items-center">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="<?php echo e(route('runner.events')); ?>" class="hover:text-brand-teal transition-colors">Semua Event</a>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                <svg class="w-4 h-4 text-gray-400 mx-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                                <span class="text-brand-navy"><?php echo e($event->name); ?></span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-brand-border overflow-hidden mb-10 relative">
                    <div class="h-64 sm:h-80 w-full relative">
                        <img src="<?php echo e(asset('storage/' . $event->banner_image)); ?>" onerror="this.src='https://images.unsplash.com/photo-1552674605-15c3705922e6?auto=format&fit=crop&q=80&w=1200'" class="w-full h-full object-cover">
                        ...
                        <div class="absolute bottom-0 left-0 w-full p-6 sm:p-10 text-white flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6">
                            <div>
                                ...
                                <h1 class="text-3xl sm:text-4xl lg:text-5xl font-black mb-2"><?php echo e($event->name); ?></h1>
                                <p class="text-brand-light/80 text-sm max-w-2xl"><?php echo e($event->description ?? 'Temukan foto-foto terbaik Anda dari event ini.'); ?></p>
                            </div>
                            <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 text-center min-w-[120px]">
                                ...
                                <p class="text-3xl font-black text-brand-teal"><?php echo e(number_format($event->photos->count() ?? 0, 0, ',', '.')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex justify-between items-end mb-6">
                        <div>
                            ...
                            <p class="text-brand-muted text-sm mt-1">Semua foto jepretan fotografer dari event <?php echo e($event->name); ?></p>
                        </div>
                    </div>

                    <!-- Masonry-style Grid Container -->
                    <div class="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-6 space-y-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $event->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <!-- Photo Item -->
                        <div class="break-inside-avoid group relative rounded-2xl overflow-hidden cursor-pointer bg-gray-100 border border-brand-border shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                            <img src="<?php echo e(asset('storage/' . $photo->watermark_path)); ?>" onerror="this.src='https://images.unsplash.com/photo-1552674605-15c3705922e6?auto=format&fit=crop&q=80&w=600'" class="w-full h-auto object-cover" alt="Run Photo">
                            ...
                            <div class="absolute inset-0 bg-brand-navy/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-4">
                                <div class="flex justify-between items-start">
                                    <span class="bg-white/90 text-brand-navy text-[10px] font-black px-2 py-1 rounded shadow-sm flex items-center">
                                        ...
                                        <?php echo e(substr($photo->fotografer->name ?? 'Fotografer', 0, 15)); ?>
                                ...
                                <div class="flex items-center gap-2">
                                    <button class="flex-1 bg-white text-brand-navy font-bold py-2 rounded-lg text-sm hover:bg-brand-teal hover:text-white transition-colors flex justify-center items-center gap-2 shadow-sm">
                                        ...
                                        Rp <?php echo e(number_format($photo->price, 0, ',', '.')); ?>
...
<?php /**PATH C:\Users\HP\RunSnap\resources\views/runner/event_detail.blade.php ENDPATH**/ ?>