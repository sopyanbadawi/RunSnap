            ...
            <div class="p-6 sm:p-10 w-full max-w-7xl mx-auto">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                    ...
                    <div class="flex gap-3 w-full md:w-auto">
                        ...
                        <a href="<?php echo e(route('fotografer.upload')); ?>" class="flex-1 md:flex-none bg-brand-teal text-white hover:bg-brand-tealHover px-5 py-2.5 rounded-xl font-bold transition-all text-sm shadow-[0_4px_14px_0_rgba(0,194,184,0.39)] flex items-center justify-center gap-2 decoration-none">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                    ...
                    <div class="bg-white rounded-2xl p-6 border border-brand-border shadow-sm relative overflow-hidden group">
                        ...
                        <div>
                            <h3 class="text-3xl font-black text-brand-navy">Rp <?php echo e(number_format($totalEarnings ?? 0, 0, ',', '.')); ?></h3>
                    ...
                    <div class="bg-white rounded-2xl p-6 border border-brand-border shadow-sm relative overflow-hidden group">
                        ...
                        <div>
                            <h3 class="text-3xl font-black text-brand-navy"><?php echo e(number_format($totalSales ?? 0, 0, ',', '.')); ?></h3>
                            <p class="text-sm font-medium text-brand-muted flex items-center mt-2 group-hover:translate-x-1 transition-transform">
                                <span class="bg-brand-light px-2 py-0.5 rounded text-xs mr-2"><?php echo e(number_format($totalPhotos ?? 0, 0, ',', '.')); ?> Foto Diupload</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 border border-brand-border shadow-sm relative overflow-hidden group">
                        ...
                        <div>
                            <h3 class="text-3xl font-black text-brand-navy"><?php echo e(\App\Models\Photo::where('fotografer_id', auth()->id())->distinct('event_id')->count('event_id')); ?></h3>
                            <a href="<?php echo e(route('fotografer.portfolio')); ?>" class="inline-block text-sm font-medium text-brand-teal mt-2 group-hover:translate-x-1 transition-transform hover:underline cursor-pointer">
                                Lihat Koleksi &rarr;
                            </a>
                        </div>
                    </div>
...
</html><?php /**PATH C:\Users\HP\RunSnap\resources\views/fotografer/dashboard.blade.php ENDPATH**/ ?>